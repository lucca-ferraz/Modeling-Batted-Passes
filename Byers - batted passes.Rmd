...
#ydstogo, score_differential and down have coefficients of basically 0
#cpoe estimate of -0.07 ish for both def and qb randomness
# cp estimate almost 3 for each def and qb randomness

# DEFENSIVE ROUTE
#fit and summary
all_fit <- glmer(is_batted ~ pass_location + pass_length + shotgun + cp+ (1 | defteam),
                     family = binomial,
                     data = pass_by_qb_2023)
...
# QB ROUTE
#fit and summary
all_fit_qb <- glmer(is_batted ~ pass_location + pass_length + shotgun +  cp+(1 | passer_player_name),
                     family = binomial,
                     data = pass_by_qb_2023)
